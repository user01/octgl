...
// Source: https://raw.githubusercontent.com/enriched/typed-ramda/413395cd890d7f3236ced0a9718da9a3869840ec/ramda.d.ts
...
module R {
    ...
    interface Static {
        ...
        */
        ...
        curryN(length: number, fn: (...args: any[]) => any): AnyCurriedFunction;
...
declare module 'ramda/ramda' {
import main = require('~ramda/ramda');
export = main;
}
